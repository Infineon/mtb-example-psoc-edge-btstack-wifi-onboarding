...
The following example clones the "[BTStack WiFi](https://github.com/Infineon/mtb-example-psoc-edge-btstack-wifi-onboarding)" application with the desired name "BTStackWiFi" configured for the *KIT_PSE84_EVAL_EPC2* BSP into the specified working directory, *C:/mtb_projects*:

   ```
   project-creator-cli --board-id KIT_PSE84_EVAL_EPC2 --app-id mtb-example-psoc-edge-btstack-wifi-onboarding --user-app-name BTStackWiFi --target-dir "C:/mtb_projects"
   ```
